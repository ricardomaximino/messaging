...
public class ContactConverter {
	...
	public Contact toContact(ContactDTO dto) {
		return new Contact(dto.getId(), dto.getContact(), dto.getProfileId(), dto.getActivityList(), dto.getResultId(), dto.getOrigin());
	}
	
	public ContactDTO toContactDTO(Contact contact, String operator) {
		return new ContactDTO(operator, contact.getId(), contact.getContact(), contact.getProfileId(), contact.getActivityList(), contact.getResultId(), contact.getOrigin());
	}
